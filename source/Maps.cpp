...
MapClass::MapClass(int Layer, int MapBase, int TileBase, const u16 *Pal, const u8 *Tiles, const u16 *Map, int TileSize) {
...
void MapClass::Update(PlayerClass *Player, const u16 MapData[]){
